...
../../bin/mitoquest caller -t 4 -f chrM_rCRS.decoy.fa.gz -Q 0 -r chrM -o tt smp1.cram smp2.cram smp3.cram
...
python ../../tools/mtDNA_variant_QC.py --vcf t.ann.vcf.gz --output test.csv --output-vcf test.vcf
